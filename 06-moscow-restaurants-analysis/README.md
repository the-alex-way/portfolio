...
![Распределение заведений по административным районам Москвы](images/02-establishments-by-district.png)
...
![Сетевые и несетевые заведения по категориям](images/04-chain-vs-independent-by-category.png)
